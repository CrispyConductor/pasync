...
// Task functions
exports.series = convertTaskFunction(async.series, 0, 0, 1, false);
exports.parallel = convertTaskFunction(async.parallel, 0, 0, 1, false);
exports.parallelLimit = convertTaskFunction(async.parallelLimit, 0, 0, 2, false);
...
/*
exports.concatLimit = function(collection, limit, iterator) {//convertIteratorFunction(async.concatLimit, 2, 1, 3, false, false);
	console.log(Array.isArray(collection));
	console.log(limit);
	console.log(typeof limit);

console.log(async.concatLimit.toString());

	var callbackIterator = constructIterator(iterator, 1, false, false);
	return new Promise(function(resolve, reject) {
		async.concatLimit(collection, limit, callbackIterator, function(err, result) {
			if(err) {
				console.log('err: ' + err)
				reject(err);
			} else {
...
exports.concatLimit = convertIteratorFunction(async.concatLimit, 2, 1, 3, false, false);
...
exports.someSeries = convertIteratorFunction(async.someSeries, 1, 1, 2, false, true);
